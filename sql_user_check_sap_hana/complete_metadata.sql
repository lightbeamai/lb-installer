...
WHERE
    tc.SCHEMA_NAME NOT LIKE '_SYS%' AND tc.SCHEMA_NAME NOT LIKE 'SYS%' AND tc.SCHEMA_NAME NOT LIKE 'PAL%' AND tc.SCHEMA_NAME NOT LIKE 'SAP%'
ORDER BY
    tc.TABLE_NAME,
    tc.COLUMN_NAME